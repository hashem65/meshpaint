...
while True: 
    alpha1 = randint (1,1000)
    alpha2 = randint (1,1000)
    alpha3 = randint (1,1000)
    alpha4 = randint (1,1000)
    kappa = math.pow(10,-7*alpha1/1000)       #should be something between 1 to 10E-7
    tau =   math.pow(10,-7*alpha1/1000)       #should be something between 1 to 10E-7
    ratioRefin = alpha3*0.8/1000+0.1          #should be something between 0.1 to 0.9
    criteriaDistance = alpha4*80/1000 + 20    #should be something between 20 to 100
    for wallNodeIdx in range(1,numberOfWallNodes+1):
        for lengthNodeIdx in range(1,numberOfLengthNodes+1):
            for circumfrentialNodeIdx in range(1,numberOfCircumfrentialNodes+1):
                nodeNumber = circumfrentialNodeIdx + (lengthNodeIdx-1)*numberOfCircumfrentialNodes + (wallNodeIdx-1)*numberOfCircumfrentialNodes*numberOfLengthNodes 
...
#        decomposition.TopologyDataProjectionCalculate()
        ...
        if (rmsError < rmsInitial):
            print("RMSFitting = "+ str(rmsError))
            print  "kappa =" , kappa, "tau =", tau ,   "criteriaDistance = ", criteriaDistance #, "ratioRefin=", ratioRefin
